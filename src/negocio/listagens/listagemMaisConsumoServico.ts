...
export default class listagemMaisConsumoServico extends Listagem{
    ...
    public listar(): void {
        ...
        orderedCli.sort((a,b) => b.getServicosConsumidos.length - a.getServicosConsumidos.length)
        console.log(' ')
        console.log(`10 Clientes que mais consumiram serviços em quantidade`)
        let i = 0
